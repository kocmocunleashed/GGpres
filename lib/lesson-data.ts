...
export const lessonScenes: LessonScene[] = [
  ...
  { id: 'files-demo', type: 'demoBridge', chapter: '06', title: 'FOLLOW\nTHE PATH.', body: 'The desktop and terminal are two ways to explore the same virtual filesystem. Everything here stays inside this lesson.', demoApp: 'files', demoLabel: 'Explore Files', steps: ['Open Documents in your home folder.', 'Read notes.txt.', 'Find /etc/os-release to meet WaveOS.'], provenance: 'teaching-demo' },
  ...
  { id: 'fedora', type: 'compare', chapter: '11', title: 'PUT NAMES\nTO THE LAYERS.', body: 'Fedora Workstation brings these pieces together. WaveOS borrows its desktop sensibility for this fictional, in-browser learning environment.', compare: 'fedora', provenance: 'clarification' },
