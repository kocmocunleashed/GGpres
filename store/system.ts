...
export type AppId = "lesson" | "files" | "terminal" | "system-monitor" | "settings" | "about" | "software";
...
export const APP_META: Record<AppId, { title: string; processName: string; color: string; memory: number; cpu: number; description: string }> = {
  ...
  about: { title: "About WaveOS", processName: "about", color: "#9e9aff", memory: 32, cpu: 0.1, description: "Meet your workstation" },
...
const baseProcesses = (): ProcessState[] => [
  ...
  { pid: 42, name: "wave-shell", memory: 256, cpu: 1.2, protected: true },
...
type SystemStore = {
  ...
  muted: boolean; reducedMotion: boolean; motionPaused: boolean; wallpaper: "wave" | "dusk";
...
export const useSystemStore = create<SystemStore>((set, get) => ({
  ...
  reducedMotion: false, motionPaused: false, wallpaper: "wave", lessonIndex: 0, lessonComplete: false,
