import { Activity, FileText, Folder, Info, Settings2, ShoppingBag, Terminal } from "lucide-react";
import type { AppId } from "@/store/system";
import WaveMark from "@/components/visual/WaveMark";

const icons = { files: Folder, terminal: Terminal, "system-monitor": Activity, settings: Settings2, about: Info, software: ShoppingBag };
